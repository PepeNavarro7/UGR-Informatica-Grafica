...
void _jirafa::seleccion(){
  ...
  glPushMatrix();
    ...
    glRotatef(this->giro_cuerpo,0,1,0);
    glTranslatef(0,ALTURA+cuerpo.alto/2,0);
    this->cuerpo.draw(SELECT,color.r,color.g,color.b,grosor_select);
    ...
    glTranslatef(-cuerpo.ancho/3,-cuerpo.alto/2,+cuerpo.fondo/3);
    this->articulacion.draw(SELECT,color.r,color.g,color.b,grosor_select);
    glTranslatef(0,-ALTURA/2,0);
    this->pata.draw(SELECT,color.r,color.g,color.b,grosor_select);
  ...
  glPushMatrix(); // Cuello y cabeza
    ...
    glRotatef(this->giro_cuello_1,0,0,1);
    glTranslatef(0,cuello.largo,0);
    this->cuello.draw(SELECT,color.r,color.g,color.b,grosor_select);
    ...
    glTranslatef(0,cuello.largo,0); 
    glRotatef(this->giro_cabeza,0,0,1);
    this->cabeza.draw(SELECT,color.r,color.g,color.b,grosor_select);
  glPopMatrix();
  ...
  glPushMatrix(); // Cola
    ...
    glRotatef(this->giro_cola,0,0,1);
    glTranslatef(cola.largo,0,0);
    this->cola.draw(SELECT,color.r,color.g,color.b,grosor_select);
  glPopMatrix();
}